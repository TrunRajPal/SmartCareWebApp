    ...
    if (email === "admin@admin.com" && password === "123456") {
      ...
      firebase
        ...
        .then((result) => {
          ...
          localStorage.setItem("dusertype", "guardian");
          ...
          history.push("/guardian/gdashboard");
        })
    ...
    <>
      <div className="main">
        <div className=" w3l-login-form">
          ...
          <br />
          <center>
            <Link to="/guardian/gsignup" className="register">
              Click Here To Register As Guardian
            </Link>
            <br />
          </center>
          <br />
...
export default connect(mapStateToProps, mapDispatchToProps)(GuardianHome);
