...
function GProfile(props) {
  ...
  useEffect(() => {
    console.log(localStorage.getItem("duseruids"));
    if (
  ...
  const add = () => {
    ...
    console.log(localStorage.getItem("duseremail"));
    console.log(localStorage.getItem("duserpassword"));

    firebase
      .database()
      .ref("students/" + localStorage.getItem("duseruids"))
      .set({
        name: name,
        dob: dob,
        age: age,
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      {motivation === "Self Motivated" ? (
                        ...
                        <div className="form-group col-md-4">
                          <label htmlFor="inputPassword4">Motivation</label>
                          <div className="form-check">
                            <input
                              className="form-check-input"
                              type="radio"
...
export default connect(mapStateToProps, mapDispatchToProps)(GProfile);
